...
class OwnerDocumentController extends BaseController
{
    ...
    public function uploadDocument(Request $request, Owner $owner, OwnerNeededDocument $needed_document)
    {
    ...
    public function uploadOwnerDoc($name,$expiry_date = null,Request $request,Owner $owner, OwnerNeededDocument $needed_document, $doc_number = null){

        $created_params['expiry_date'] = $expiry_date;
        $created_params['doc_number']=$doc_number;
