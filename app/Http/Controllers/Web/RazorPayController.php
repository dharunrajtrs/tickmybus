...
// dd($this->api->order);
        ...
        $journey_id = $request->input('journey_id') ?? "test";
        ...
        return view('Razorpay.razorpay', ['order' => $order, 'key' => $keyId, 'payment_for' => $payment_for, 'journey_id' => $journey_id, 'user' => $user, 'amount'=>$request->input('amount'), 'currency' => $currency]);
    }
