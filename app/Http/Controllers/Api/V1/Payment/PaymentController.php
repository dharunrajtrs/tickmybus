    ...
    public function walletHistory()
    {
        ...
        $url = env('APP_URL');
            ...
            $payment_gateways = array(
                ...
                'stripe' => array('enabled' => $enable_khalti_pay,
                'image' => $khalti_image,
                'url' => $url."/khalti"),
...
//        return $this->respondSuccess($remarks, 'transferred');
   ...
   public function ticketFareByWallet(Request $request)
    {
...
//user wallet
        ...
        if ($user_wallet->amount_balance < $ticket_fare) {
            // Throw exception
            $this->throwCustomException('Insufficient Balance');
        }


            $user_wallet->amount_spent += $ticket_fare;
            $user_wallet->amount_balance -= $ticket_fare;
            $user_wallet->save();
            ...
            $wallet_history_model::create([
                ...
                'amount' => $ticket_fare,
                'transaction_id' => $transaction_id,            
                'remarks' => 'Ticket Fare Deducted',
                'is_credit' => false]);            

        $title = trans('push_notifications.payment_completed_by_user_title',[],$user->lang);
        $body = trans('push_notifications.payment_completed_by_user_body',[],$user->lang);
