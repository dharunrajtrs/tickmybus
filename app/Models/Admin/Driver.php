...
class Driver extends Model
{
     ...
     */
    protected $fillable = [
        'user_id','owner_id','service_location_id', 'name','mobile','email','address','state','city','country','postal_code','gender','total_accept','total_reject','last_trip_date','active','approve','available','reason','fleet_id'
    ];
    /**
    ...
    */
    protected $appends = [
        'profile_picture','rating','no_of_ratings','timezone',
    ];
    ...
    */
    ...
    {
        return $this->hasMany(Journey::class, 'driver_id', 'id');
    }
