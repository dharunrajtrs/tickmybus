...
class User extends Authenticatable implements CanSendOTPContract
{
     ...
     */
    public $sortable = [
        'id', 'name', 'username', 'email', 'mobile', 'profile_picture', 'last_login_at', 'created_at', 'updated_at','gender'
    ];
    ...
    public function getProfilePictureAttribute($value)
    {
        if (!$value) {
            ...
            if($this->roles[0]->name == 'Owner'){
                $default_image_path = config('base.default.owner.profile_picture');
            }
    ...
    */
    ...
    {
        return $this->hasOne(JourneyUser::class, 'user_id', 'id');
    }
