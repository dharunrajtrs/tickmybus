...
class Settings
{
    ...
    const MAXIMUM_NUMBER_OF_SEATS_USER_CAN_BOOK='maximum_number_of_seats_user_can_book';
    const AMOUNT_REFUND_IN_X_DAYS = 'amount_refund_in_x_days';

    const ADMIN_COMMISSION_TYPE_FOR_BUS_COMPANY='admin_commission_type_for_bus_company';
    const ADMIN_COMMISSION_FOR_BUS_COMPANY='admin_commission_for_bus_company';
