...
class ImageUploader implements ImageUploaderContract
{
     ...
     * @return string Returns the saved filename
     */
    public function saveBusImages()
    {
        $this->validateFile();

        $config = $this->config('bus.upload.images');
    ...
    public function saveAmenityTypeImage()
    {
        $this->validateFile();

        $config = $this->config('bus-amenities.upload.images');
    ...
    public function saveAboutImage()
    {
        $this->validateFile();
    ...
    public function saveServiceImage()
    {
        $this->validateFile();
    ...
    public function saveContactImage()
    {
        $this->validateFile();
    ...
    public function savePrivacyImage()
    {
        $this->validateFile();
