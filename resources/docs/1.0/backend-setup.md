...
<a name="section-1"></a>
## Introduction
You are almost finished and ready . To set up your back end part, i.e, once you have set up jenkins and taken a build or just uploaded the laravel project in your project path, Please follow the steps for running your own server app.
...
* Setup DB config in .env file
    ...
    ```php
    APP_URL=http://mi_bus.com/future/public
    ```
   ```php
   DB_PORT=3306
...
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS=suport@mibus.com
MAIL_FROM_NAME="mi-bus"
AWS_ACCESS_KEY_ID=
