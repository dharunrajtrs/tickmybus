    ...
    <script>
        ...
        var options = {
            ...
            handler: function (response){
                ...
                var redirectUrl = paymentSuccessUrl + "?payment_for=" + payment_for + "&user_id=" + user_id + "&journey_id=" + journey_id + "&amount=" + request_amount + "&order_id=" + orderId;
