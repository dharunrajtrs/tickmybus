            ...
            <div class="row">
                <div class="col-md-4 col-12">
                    <div class="profile-user-info">
                      ...
                      <p>@lang('view_pages.address') :<span class="text-gray pl-10">{{ $user->address ?? '' }}</span></p>
                  </div>
               </div>
                ...
                <div class="box p-15">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" id="first_name" name="first_name" value="{{old('first_name',$user->name ?? '')}}" required="" placeholder="@lang('view_pages.enter_first_name')">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" id="address" name="address" value="{{old('address',$user->owner->address ?? '')}}" required="" placeholder="@lang('view_pages.enter_address')">
