...
<body class="hold-transition login-page">
    ...
    <div class="container h-p100">
        <div class="row align-items-center justify-content-md-center h-p100">
            ...
            <div class="col-lg-4 col-md-8 col-12" style="padding-bottom: 90px">
                <div class="login-box">
                    <div class="login-box-body text-center">
                        <div class="print-error-msg" style="position: absolute;right: 0;left: 0;">
                            <ul class="error-style"></ul>
                        </div>
                        <img src="assets/images/favicon.png" alt="" style="width:100px;">
                        <h3 class="text-center">@lang('view_pages.bus_operator_panel')</h3>
