...
<div class="box">
                ...
                <div class="col-1">
                    ...
                    @if(auth()->user()->can('add-owner'))
                            <div class="col-9 text-right">
                                <a href="{{ url('owners/create')}}" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i>@lang('view_pages.add_bus_company')</a>
                            </div>
                    @endif
    ...
    <div id="js-project-partial-target">
        <include-fragment src="by_area/fetch">
