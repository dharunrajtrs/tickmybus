...
<div class="row">
    <div class="col-sm-6 float-left mb-md-3">
        <div class="form-group">
        <label for="company_name">@lang('view_pages.travels_name')
        <span class="text-danger">*</span></label>
        <input class="form-control" type="text" id="company_name"
        name="company_name" value="{{ old('company_name') }}"
        required=""
        placeholder="@lang('view_pages.enter') @lang('view_pages.travels_name')">
        <span
...
{{--
        ...
        <div class="col-sm-6 float-left mb-md-3"  style="display: none;">
            ...
            <div class="col-sm-6 float-left mb-md-3">
            <div class="form-group">
            <label for="tax_number">@lang('view_pages.gst_number')<span
            class="text-danger">*</span></label>
            <input class="form-control" type="text" id="tax_number"
            name="tax_number" value="{{ old('tax_number') }}"
            required=""
            placeholder="@lang('view_pages.enter') @lang('view_pages.gst_number')">
            <span
            ...
            <div class="col-sm-12 float-left mb-md-3">
                ...
                name="headquarters_pincode" value="{{ old('headquarters_pincode') }}"
                required=""
                ...
                class="text-danger">*</span></label>
                <input class="form-control" type="text" id="locality"
                name="headquarters_city" value="{{ old('headquarters_city') }}" required=""
...
<div class="col-sm-6  float-left mb-md-3">
    ...
    <input class="form-control" type="text" name="doc_number[]" value="{{ old('doc_number') }}"  placeholder="@lang('view_pages.document_number')" required>
    </div>
    </div>
...
<span class="input-group-btn">
<span class="btn btn-default btn-file">
@lang('view_pages.browse')… <input type="file" class="imgInp" name="company_logo" required>
</span>
</span>
<input type="text" class="form-control" readonly>
</div>
