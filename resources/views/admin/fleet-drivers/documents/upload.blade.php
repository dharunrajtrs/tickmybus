...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <a href="{{ url('fleet-drivers/document/view',$driver->id) }}">
        ...
        <div class="col-sm-12">
            <form  method="post" class="form-horizontal" action="{{url('fleet-drivers/upload/document',[$driver->id,$needed_document->id])}}" enctype="multipart/form-data">
            {{csrf_field()}}
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="document">@lang('view_pages.document') (100kB - 5MB)</label><br>
