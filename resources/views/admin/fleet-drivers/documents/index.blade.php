            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="comment_td">
                     ...
                     <td>
                        @if($count == 0)
                            <a href="{{ url('fleet-drivers/upload/document',[$driver->id,$item->id]) }}" class="fas fa fa-upload"></a>
                        @else
                            ...
                            <a href="{{ url('fleet-drivers/upload/document',[$driver->id,$item->id]) }}" class="fas fa fa-edit"></a>
                            {{-- <a href="{{ url('fleet-drivers/delete/document',[$driver_doc_id]) }}" class="fas fa fa-trash text-red sweet-delete"></a> --}}
                        @endif
                    </td>
...
$(document).on('click','#approveDocument',function(){
    var url = "{{ url('fleet-drivers') }}";

    $.ajax({
        url: '{{ route("approveFleetDriverDocument") }}',
        data: $('form').serialize(),
        method: 'post',
