            ...
            <div class="col-sm-6 col-md-3">
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        <h6>@lang('view_pages.companies_registerd')
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            {{ count($total_owners) }}
                        </div>
                        <!-- <a class="font-weight-semi-bold fs--1 text-nowrap" href="{{url('owners')}}">@lang('view_pages.see_all')<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a> -->
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>@lang('view_pages.no_of_buses')
                            <!-- <span class="badge badge-soft-success rounded-pill ml-2">10%</span> -->
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}"> {{ count($fleets) }}
                        </div>
                             <a class="font-weight-semi-bold fs--1 text-nowrap"
                            href="{{url('fleets')}}">@lang('view_pages.see_all')<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a> 
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>@lang('view_pages.completed_journeys')
                            <!-- <span class="badge badge-soft-success rounded-pill ml-2">10%</span> -->
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-success"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            {{ count($completed_journeys) }}</div><a class="font-weight-semi-bold fs--1 text-nowrap" href="{{url('journey/completed')}}">@lang('view_pages.see_all')<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="font-weight-600">@lang('view_pages.today_journeys')</h3>
                            ...
                            <div class="box-body row">
                                <div class="col-md-6">
                                    <canvas id="journeys" height="200"></canvas>
                                </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content" style="color: #455a80">
                                                    <h4 class="font-weight-600">
                                                        ...
                                                        {{$currency}}  {{$userAdminCommision}}

                                                        <br>
                                                        @lang('view_pages.admin_commision_from_user')
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content" style="color: #455a80">
                                                    <h4 class="font-weight-600">
                                                        {{$currency}}  {{$companyAdminCommision}}
                                                        <br>
                                                        @lang('view_pages.admin_commision_from_bus_company')
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>                            
...
<!-- Overall Earnings -->
                            ...
                            <div class="row">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content" style="color: #fc4b6c">
                                            <h4 class="font-weight-600">
                                                ...
                                                {{$currency}} {{$ovearAlluserAdminCommision}}
                                                <br>
                                                @lang('view_pages.admin_commision_from_user')
                                            </h4>
                                        </div>
                              ...
                              <div class="col-md-6">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content" style="color: #455a80">
                                            <h4 class="font-weight-600">
                                                {{$currency}}  {{$ovearAllcompanyAdminCommision}}
                                                <br>
                                                @lang('view_pages.admin_commision_from_bus_company')
                                            </h4>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-body bg-primary">
                                            <div class="flexbox">
                                                ...
                                                <span class="font-size-40 font-weight-200">{{$journeys[0]['total_cancelled']}}</span>
                                            </div>
                                            <div class="text-right">@lang('view_pages.total_cancelled_bookings')</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box box-body bg-primary" style="background-color: #1e88e5 !important">
                                            <div class="flexbox">
                                                <span class="ion ion-ios-person-outline font-size-50"></span>
                                                <span class="font-size-40 font-weight-200">{{$journeys[0]['auto_cancelled']}}</span>
                                            </div>
                                            <div class="text-right">@lang('view_pages.today_cancelled_bookings')</div>
                                        </div>
                                    </div>
                                   <!--  <div class="col-md-6">
                                        <div class="box box-body bg-primary" style="background-color: #26c6da !important">
                                            <div class="flexbox">
                                                <span class="ion ion-ios-person-outline font-size-50"></span>
                                                <span class="font-size-40 font-weight-200">{{$journeys[0]['user_cancelled']}}</span>
                                            </div>
    ...
    <script src="{{ asset('assets/vendor_components/jquery.peity/jquery.peity.js') }}"></script>
        ...
        $(document).ready(function() {
            ...
            var cancelData = JSON.parse('<?php echo json_encode($cancelData); ?>');

            var todayJourneys = JSON.parse('<?php echo json_encode($todayJourneys); ?>');
            var todayCancelledJourneys = JSON.parse('<?php echo json_encode($todayCancelledJourneys); ?>')


            todayJourneys = Object.values(todayJourneys);
            todayCancelledJourneys = Object.values(todayCancelledJourneys);

           console.log(todayCancelledJourneys);

            if ($('#journeys').length > 0) {
                var ctx7 = document.getElementById("journeys").getContext("2d");
                var data7 = {
                    labels: [
                        "Completed",
                        "Cancelled",
                    ...
                    datasets: [{
                        data: [todayJourneys[0].today_completed,todayCancelledJourneys[0].today_cancelled,todayJourneys[0].today_scheduled],
                        backgroundColor: [
                            "#7460ee",
                            "#fc4b6c",
                            "#26c6da"
         ...
         var barChartData = barData?.cancel;
            var overallEarning = cancelData?.earnings;
            let cancelValues = [];
