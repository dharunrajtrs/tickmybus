...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h2 class="card-title">Privacy Page </h2>
            
     <form method="post" class="form-horizontal" action="{{ url('privacy/update',$item->id) }}" enctype="multipart/form-data">
                @csrf

     <div class="container">

        <div><h4>Privacy Section</h4> </div>
        ...
        <div class="col-6">
            ...
            <div class="row m-3">
                <label for="privacy" class="col-sm-2 col-form-label">Privacy Paragraph </label>
                <div class="col-sm-10">
                <textarea name="privacy" class="ckeditor form-control" name="privacy"  required>
                {{ old('privacy', $item->privacy) }}
                </textarea>
                </div>
            </div> 
            </div> <br>
