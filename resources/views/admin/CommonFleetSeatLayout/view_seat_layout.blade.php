...
$seater = [
    ...
    "label"=>"Seater",
    "image"=>"/images/layout/seater.png"
];
$semiSleeper = [
    "value"=>"semi_sleeper",
    "label"=>"Semi Sleeper",
    "image"=>"/images/layout/semi.png"
];
$sleeper = [
    "value"=>"sleeper",
    "label"=>"Sleeper",
    "image"=>"/images/layout/sleeper.png"
];
$blocker = [
    "value"=>"blocker",
    "label"=>"Blocker",
    "image"=>"/images/layout/blocked.png"
];
...
<form method="post" action="{{url('common_fleet_seat_layout/update')}}">
              @csrf
<div class="container">
<div class="card">
  <div class="card-body">
  <div class="row p-2">
    <div class="col-sm-12">
        <div class="box-header with-border">
            <a href="{{ url('common_fleet_seat_layout') }}">
...
function submitFormData(){
    ...
    swal({
        ...
        if (isConfirm) {
            swal.close();
            $.ajax({
                url:"{{url('common_fleet_seat_layout/update')}}",
                type: "POST",
                ...
                success: function(response) {
                    ...
                    if(message){
                        swal({title: message});
                        window.location = "/tickmybus/public/common_fleet_seat_layout/";
                    }
                }
            });
        }
