                                ...
                                <tr>
                                  ...
                                  <div class="dropdown">
                                           ...
                                           <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{url('common_fleet_seat_layout/edit/'.$result->fleet_id) }}">{{ trans('view_pages.view_and_modify_seats')}}
                                                </a>

                                               @if (auth()->user()->can('delete_seat_layout'))
                                                <a class="dropdown-item sweet-delete"  href="#" data-url="{{url('common_fleet_seat_layout/delete/'.$result->fleet_id)}}">{{ trans('view_pages.delete')}}</a>
                                                @endif
