...
<header class="main-header">
    ...
    <a href="#" class="logo">
        <!-- mini logo -->
        <b class="logo-mini">
             <span class="light-logo" style="display: flex;align-items: center;"><img
                     src="{{ app_logo() ?? asset('images/email/trslogo.png') }}" style="height:60px; width:70px;padding-right: 5px;"
                     alt="logo"></span>
