        ...
        <tr>
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
                ...
                @if(auth()->user()->can('manage-boarding-point'))
                    <a class="dropdown-item" href="{{url('admin_boarding_point',$result->id)}}"><i class="fa fa-pencil"></i>@lang('view_pages.edit')</a>
                @endif
                 ...
                 {{-- @if($result->active)
                    ...
                    <a class="dropdown-item sweet-delete" href="{{url('admin_boarding_point/delete',$result->id)}}"><i class="fa fa-trash-o"></i>@lang('view_pages.delete')</a>
                </div>
            </div>
