...
<div class="row">
    <div class="col-12">
        ...
        <div id="js-route-partial-target">
            <include-fragment src="routes/fetch">
...
<script>
    ...
    $('body').on('click', '.pagination a', function(e) {
        ...
        $.get(url, $('#search').serialize(), function(data){
            $('#js-route-partial-target').html(data);
        });
    });
    ...
    $('#search').on('click', function(e){
        e.preventDefault();
            ...
            fetch('routes/fetch?search='+search_keyword)
            .then(response => response.text())
            .then(html=>{
                document.querySelector('#js-route-partial-target').innerHTML = html
            });
    });
