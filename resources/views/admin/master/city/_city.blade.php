        ...
        <tr>
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
                ...
                {{-- @if(auth()->user()->can('edit-city')) --}}
                    <a class="dropdown-item" href="{{url('city',$result->id)}}"><i class="fa fa-pencil"></i>@lang('view_pages.edit')</a>
                {{-- @endif --}}

                {{--   @if($result->active)
                    <a class="dropdown-item" href="{{url('city/toggle_status',$result->id)}}"><i class="fa fa-dot-circle-o"></i>@lang('view_pages.inactive')</a>
                    @else
                    <a class="dropdown-item" href="{{url('city/toggle_status',$result->id)}}"><i class="fa fa-dot-circle-o"></i>@lang('view_pages.active')</a>
                    @endif     --}}

                     <a class="dropdown-item sweet-delete" href="{{url('city/delete',$result->id)}}"><i class="fa fa-trash-o"></i>@lang('view_pages.delete')</a>
                </div>
            </div>
