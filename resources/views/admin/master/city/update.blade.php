                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('city/update',$item->id) }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                         ...
                                         <!--     <input type="hidden" class="form-control" id="city_lat"
                                                        name="city_lat">
                                                    <input type="hidden" class="form-control" id="city_lng"
                                                        name="city_lng"> -->
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
