                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('promo/update',$item->id) }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="minimum_ticket_amount">@lang('view_pages.minimum_ticket_amount') <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" id="minimum_ticket_amount" name="minimum_ticket_amount"
                                                value="{{ old('minimum_ticket_amount',$item->minimum_ticket_amount) }}" required
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.minimum_ticket_amount')">
                                            <span class="text-danger">{{ $errors->first('minimum_ticket_amount') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
